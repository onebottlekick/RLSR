...
class ipt(nn.Module):
    def __init__(self, patch_size=48, n_feats=64, patch_dim=3, n_colors=3, scale=2, rgb_range=1., num_heads=12, num_layers=12, num_queries=1, dropout_rate=0, no_mlp=False, pos_every=False, no_pos=False, no_norm=False, conv=default_conv):
        ...
        self.body = VisionTransformer(img_dim=patch_size, patch_dim=patch_dim, num_channels=n_feats, embedding_dim=n_feats*patch_dim*patch_dim, num_heads=num_heads, num_layers=num_layers, hidden_dim=n_feats*patch_dim*patch_dim*4, num_queries = num_queries, dropout_rate=dropout_rate, mlp=no_mlp ,pos_every=pos_every,no_pos=no_pos,no_norm=no_norm)
